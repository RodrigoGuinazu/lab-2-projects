    ...
    while(control == 's'){
        ...
        case 2: ;
            if(currentUser.id == 0){
                ...
                printf("[6] - Activar un Usuario\n");
                printf("[7] - Dar de baja un Usuario\n");
                printf("[8] - Log Out\n");
                ...
                switch(option2){
                    ...
                    case 6: ;
                    ldl = activarUsuarioPorId("archivoUsuarios.dat", ldl);
                    ...
                    case 7: ;
                    ldl = darDeBajaUsuarioPorId("archivoUsuarios.dat", ldl);
                ...
                switch(option2){
                    ...
                    if(currentUser.cantPeliculas == 0){
                        ...
                        mostrarListaCurrentUser(currentUser, ldl);
                        control = 's';
                        while(control == 's'){
...
void menuPeliculas(int option1, nodoArbol* arbol){
    ...
    switch(option1){
        ...
        fflush(stdin);
        gets(busqueda);
        int buscado = resultadoDeBusqueda(arbol, busqueda);
        if(buscado==0){
            red();
            printf("\nNo hay resultados\n");
            white();
